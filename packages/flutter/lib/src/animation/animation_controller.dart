    ...
    assert(() {
      if (_ticker == null) {
        throw FlutterError(<DiagnosticsNode>[
          ...
          ErrorHint('A given $runtimeType cannot be disposed more than once.\n'),
          ErrorProperty<AnimationController>('The following $runtimeType object was disposed multiple times', this),
        ]);
      }
      return true;
    }());
