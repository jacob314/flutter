...
class RenderFlex extends RenderBox with ContainerRenderObjectMixin<RenderBox, FlexParentData>,
  ...
  void debugFillProperties(List<DiagnosticsNode> description) {
    ...
    description.add(new DiagnosticsNode.enumProperty('direction', _direction));
    description.add(new DiagnosticsNode.enumProperty('mainAxisAlignment', _mainAxisAlignment));
    description.add(new DiagnosticsNode.enumProperty('mainAxisSize', _mainAxisSize));
    description.add(new DiagnosticsNode.enumProperty('crossAxisAlignment', _crossAxisAlignment));
    description.add(new DiagnosticsNode.enumProperty('textBaseline', _textBaseline));
  }
