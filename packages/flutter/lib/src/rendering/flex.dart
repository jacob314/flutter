      ...
      if (flex > 0) {
        assert(() {
          ...
          if (!canFlex && (mainAxisSize == MainAxisSize.max || _getFit(child) == FlexFit.tight)) {
            ...
            addendum.add(ErrorHint('See also: https://flutter.io/layout/'));
          } else {
            return true;
          }
          throw FlutterError(<DiagnosticsNode>[
            ...
            ErrorProperty<dynamic>('The creator information is set to', debugCreator, style: DiagnosticsTreeStyle.indentedSingleLine)
          ]..addAll(addendum)
           ..add(ErrorHint(
        ...
        if (crossAxisAlignment == CrossAxisAlignment.baseline) {
          assert(
            ...
            FlutterError(<DiagnosticsNode>[
              ErrorSummary('To use FlexAlignItems.baseline, you must also specify which baseline to use using the "baseline" argument.'),
            ])
          );
