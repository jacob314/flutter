...
class RenderFlex extends RenderBox with ContainerRenderObjectMixin<RenderBox, FlexParentData>,
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    assert(() {
      ...
      // _direction changes.
      final String description = 'The overflowing $runtimeType has an orientation of $_direction.';

      final List<String> debugOverflowHints = <String>[
      ...
      paintOverflowIndicator(context, offset, Offset.zero & size, overflowChildRect, description: description, overflowHintsBuilder: debugOverflowHints);
      return true;
    }());
  }
