...
class TextTreeConfiguration {
  ...
  /// Prefix to add to the first line to display a child with this style if the
  /// first line wraps.
  final String prefixLineOneWrap;
...
class _PrefixedStringBuilder {
  _PrefixedStringBuilder({
    @required this.prefixLineOne,
    @required String prefixLineOneWrap, // XXX ignored.
  ...
  void _finalizeLine(bool addTrailingLineBreak) {
    final bool firstLine = this._buffer.isEmpty;
...
class TextRenderer {
  ...
  String render(
    ...
    final _PrefixedStringBuilder builder = _PrefixedStringBuilder(
      ...
      prefixLineOneWrap: prefixLineOneWrap,
    ...
    for (int i = 0; i < properties.length; ++i) {
      ...
      if (_isSingleLine(property.style)) {
        ...
        final String propertyRender = render(property,
          ...
          prefixLineOneWrap: '${propertyStyle.childLinkSpace}${propertyStyle.prefixLineOneWrap}',
      ...
      } else
      {
        final String propertyRender = render(property,
          ...
          prefixLineOneWrap: '${builder.prefixOtherLines}${propertyStyle.childLinkSpace}${propertyStyle.prefixLineOneWrap}',
      ...
      for (int i = 0; i < children.length; i++) {
        ...
        if (i == children.length - 1) {
          ...
          builder.writeRawLines(render(
            ...
            prefixLineOneWrap: '$prefixChildrenRaw${childConfig.childLinkSpace}',
          ...
          final String childPrefixLineOneWrap ='$prefixChildrenRaw${nextChildStyle.linkCharacter}${childConfig.prefixLineOneWrap}';
          ...
          builder.writeRawLines(render(
            ...
            prefixLineOneWrap: childPrefixLineOneWrap,
            prefixOtherLines: childPrefixOtherLines,
            parentConfiguration: config,
          ));
          if (childConfig.footer.isNotEmpty) {
