    ...
    if (hitTestResult == null) {
      ...
      try {
        ...
        FlutterError.reportError(FlutterErrorDetailsForPointerEventDispatcher(
          ...
          context: ErrorDetails('while dispatching a non-hit-tested pointer event'),
          event: event,
          hitTestEntry: null,
    ...
    for (HitTestEntry entry in hitTestResult.path) {
      try {
        ...
        FlutterError.reportError(FlutterErrorDetailsForPointerEventDispatcher(
          ...
          stack: stack,
          library: 'gesture library',
          context: ErrorDetails('while dispatching a pointer event'),
          event: event,
          hitTestEntry: entry,
          informationCollector: (List<DiagnosticsNode> information) {
            information.add(ErrorProperty<PointerEvent>('Event', event));
            information.add(ErrorProperty<HitTestTarget>('Target', entry.target));
          },
        ));
      }
    }
