...
class WidgetInspectorService {
  ...
  void initServiceExtensions(
    ...
    if (isWidgetCreationTracked()) {
      ...
      debugOnPerformReassemble = _clearStats;
  ...
  void _onFrameEnd(Duration timeStamp) {
    ...
    if (_trackRepaintWidgets) {
      void _handleNonRenderObjectElementAncestors(Element element,
          RenderObject renderObject,) {
      ...
      void _onMarkNeedsPaintHelper(RenderObject renderObject) {
        ...
        _handleNonRenderObjectElementAncestors(
            renderObject.debugCreator?.element, renderObject);
      }
