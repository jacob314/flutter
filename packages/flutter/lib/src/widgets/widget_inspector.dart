...
class WidgetInspectorService {
  ...
  List<Element> _getRawElementParentChain(Element element, String groupName, {bool toFirstLocalParent : false}) {
    List<Element> elements = element?.debugGetDiagnosticChain();
    if (toFirstLocalParent) {
  ...
  List<_DiagnosticsPathNode> _getElementParentChain(Element element, String groupName, {bool toFirstLocalParent : false}) {
    return _followDiagnosticableChain(
      _getRawElementParentChain(
        element,
        groupName,
        toFirstLocalParent: toFirstLocalParent,
      ),
  ...
  @deprecated
  /// Remove this method once XXX version of the intellij has been live for XXX weeks
  ...
  String getDetailsSubtree(String id, String groupName) {
    ...
    if (value is Element) {
      ...
      pathToInclude = _getRawElementParentChain(value, groupName, toFirstLocalParent: true);
