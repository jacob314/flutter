  ...
  void debugPaintSize(PaintingContext context, Offset offset) {
    ...
    assert(() {
      ...
      context.canvas.drawLine(
          offset, offset.translate(size.width, size.height), paint);
      {
        final PictureLayer pictureLayer = new PictureLayer(Offset.zero & size);
        final ui.PictureRecorder recorder = new ui.PictureRecorder();
        final Canvas pictureCanvas = new Canvas(recorder);
...
class RepaintBoundaryWithDebugPaint extends RepaintBoundary {
  ...
  const RepaintBoundaryWithDebugPaint({ Key key, Widget child }) : super(key: key, child: child);

  @override
  RenderRepaintBoundary createRenderObject(BuildContext context) => new RenderRepaintBoundaryWithDebugPaint();
}
...
class TestWidgetInspectorService extends Object with WidgetInspectorService {
  ...
  static void runTests() {
    ...
    testWidgets('ext.flutter.inspector.screenshot',
      ...
      expect(expectedChildLayerCount, equals(1));
      await expectLater(
